...
/**
 * Build clone URL with optional proxy
 */
function buildCloneUrl(repo, proxy = null) {
  const { owner, name } = parseRepo(repo);

  let url = `https://github.com/${owner}/${name}.git`;

  // If proxy is configured, use git's http.proxy
  // This is handled in cloneRepo function
